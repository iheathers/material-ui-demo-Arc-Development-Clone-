...
exports.sendMail = functions.https.onRequest((request, response) => {
  ...
  cors(request, response, () => {
    const { email, name, phone, message } = request.query;

    mailOptions = {
      ...mailOptions,
      to: "testingmaterial0@gmail.com",
      subject: "Message received!",
      html: `<p style="font-sze: 16px">From: ${name}</p>
      <p style="font-sze: 16px">Email: ${email}</p>
      <p style="font-sze: 16px">Phone Number: ${phone}</p>
      <p style="font-sze: 16px">Message: ${message}</p>`,
    };
